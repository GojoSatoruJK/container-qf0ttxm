...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qf0ttxm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qf0ttxm.containers.anotherwebservice.com/
...
```
git clone git@github.com:GojoSatoruJK/container-qf0ttxm.git
cd container-qf0ttxm
```
...
```
docker attach container-qf0ttxm
```
